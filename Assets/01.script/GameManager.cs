...
public class GameManager : MonoBehaviour
{
    ...
    public TextMeshProUGUI scoreText;//점수를 출력할 UI 게임 오브젝트
    public GameObject gameoverUI;//게임오버 시 활성화 할 UI 게임 오브젝트
    ...
    void Awake()
    {
        //싱클턴 변수 instance가 비어 있는가?
        if (instance == null)
        {
            //instance 가 비어있다면 (null)그곳에 자기 자신을 할당 
            instance = this;
        }
